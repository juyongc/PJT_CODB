<template>
  <div id="app">
      ...
      <div class="container-fluid justify-content-center">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <router-link class="nav-link text-light fw-bold" :to="{ name: 'Recommendation' }">Recommendation</router-link>
            </li>
            <li class="nav-item">
    ...
    <footer>
      <div class="icon-group text-center mb-3">
        <p class="text-muted d-inline me-3">
      ...
      <p class="text-center text-muted mb-5">© 2021. CODb all rights reserved</p>
    </footer>
  </div>
</template>
